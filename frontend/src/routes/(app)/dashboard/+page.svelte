			...
			<div class="card">
				...
				{:else}
					<div class="text-center py-8 text-gray-400">
						...
						<p>No RFPs yet</p>
						{#if $authStore.canManageRFPs()}
							<a href="/rfps/create" class="text-blue-400 hover:text-blue-300 text-sm">
			...
			{#if $authStore.isAdmin()}
				<div class="card">
					<div class="flex items-center justify-between mb-4">
						...
						<a href="/organizations" class="text-blue-400 hover:text-blue-300 text-sm">
							Manage
						</a>
					</div>
							...
							{#each organizations as org}
								<div class="flex items-center justify-between p-3 bg-gray-700 rounded-md hover:bg-gray-600 transition-colors">
									<div class="flex items-center gap-3">
										...
										<div>
											<a href="/organizations/{org.id}" class="text-white font-medium hover:text-blue-300">
												{org.name}
											</a>
											<p class="text-gray-400 text-sm">{org.organization_type}</p>
										</div>
									</div>
									<div class="text-right">
										<span class="text-sm text-gray-400">{org.user_count || 0} users</span>
									</div>
								</div>
							{/each}
						</div>
			...
			{:else}
				...
				<div class="card">
					...
					<div class="space-y-3">
						...
						<a href="/profile" class="flex items-center gap-3 p-3 bg-gray-700 rounded-md hover:bg-gray-600 transition-colors">
							<Users size={20} class="text-purple-400" />
							<div>
								<div class="text-white font-medium">Profile</div>
								<div class="text-gray-400 text-sm">Update your information</div>
							</div>
						</a>
					</div>
				</div>
